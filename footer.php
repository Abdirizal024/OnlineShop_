		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
				    ...
				    <a class="logo" href="#">
				        <img src="frontend/img/logo3.png" alt="" style="width: 170px; height: 200px;">
				    </a>
				</div>

					<!-- /footer logo -->

					<p>Toko online penyedia Gallery Proyek Siswa terlengkap, tersedia berbagai ukuran dengan kualitas terbaik.</p>
